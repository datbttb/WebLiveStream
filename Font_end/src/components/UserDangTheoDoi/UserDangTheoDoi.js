...
function UserDangTheoDoi () {
    ...
    const getListUser = () => {
        ...
        let config = {
            ...
            url: 'http://localhost:8081/follow/get-ds-nguoi-dang-follow/'+userUsed,
            headers: { }
          };
    ...
    return (
        <div className="user-dang-theo-doi">
            <div className="App">
                <Header/>
                ...
                <div className="videos-trang-chu">
                    <div className="list-user">
                        <h2>Danh sách người đang theo dõi</h2>
                        {isLoading ? (
                            <div className="row">
                                {
                                listUser.map((item) => (
...
export default UserDangTheoDoi;